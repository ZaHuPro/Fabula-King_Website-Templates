$(document).ready(function(){
    ...
    NavBar += "                </div>";
    NavBar += "                <div role='contact' id='3' class='page col align-self-center'>  ";
    NavBar += "                        <i class='fas fa-at'></i>";
    NavBar += "                        <p  class='menuItem'>contact</p>";
    NavBar += "                    </div>";
    // NavBar += "                <div role='others' id='3' class='page col align-self-center'>  ";
    // NavBar += "                        <i class='fas fa-at'></i>";
    // NavBar += "                        <p  class='menuItem'>others</p>";
    // NavBar += "                    </div>";
    NavBar += "            </div>";
    NavBar += "        </div>";
    NavBar += "    </div>";
